...
echo "  backend/database_migrations/petimi_vet/BOOTSTRAP_NEW_SUPABASE_ALL_IN_ONE.sql"
...
echo "  - backend/database_migrations/petimi_vet/00_DIAGNOSE_DATABASE.sql"
echo "  - backend/database_migrations/petimi_vet/01_FIX_ALL_ERRORS.sql (only if diagnose says you need fixes)"
echo ""
