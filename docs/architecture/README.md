...
| [HUB_NOTES_AND_HANDOFF_BACKLOG.md](./HUB_NOTES_AND_HANDOFF_BACKLOG.md) | **Backlog pós-MVP:** notas internas, herança orçamento/agenda → comanda, congelamento de histórico |
