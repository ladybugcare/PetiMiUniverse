...
exports.completeFreelancerOnboarding = void 0;
const supabase_1 = require("../../config/supabase");
/**
 * Completa o onboarding do freelancer
 * Versão simplificada sem necessidade de CRMV
 */
const completeFreelancerOnboarding = async (req, res) => {
    try {
        ...
        const { data: existingFreelancer } = await supabase_1.supabaseAdmin
            .from('freelancers')
        ...
        const { data: updatedFreelancer, error: updateError } = await supabase_1.supabaseAdmin
            .from('freelancers')
            .update(updateData)
            .eq('id', userId)
            .select()
...
exports.completeFreelancerOnboarding = completeFreelancerOnboarding;
