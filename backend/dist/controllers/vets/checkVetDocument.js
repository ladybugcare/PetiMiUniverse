...
exports.checkVetDocument = void 0;
...
const checkVetDocument = async (req, res) => {
    ...
    try {
        ...
        if (error) {
            ...
            if (error.message?.includes('column') || error.message?.includes('does not exist')) {
                console.warn('Coluna document_number não encontrada na tabela vets');
...
exports.checkVetDocument = checkVetDocument;
