 ...
 */
function sanitizeString(input, allowBasicFormatting = false) {
 ...
 */
function sanitizeObject(obj, allowBasicFormatting = false) {
    if (obj === null || obj === undefined) {
        return obj;
    }
    if (typeof obj === 'string') {
        return sanitizeString(obj, allowBasicFormatting);
    }
    if (Array.isArray(obj)) {
        return obj.map((item) => sanitizeObject(item, allowBasicFormatting));
    }
