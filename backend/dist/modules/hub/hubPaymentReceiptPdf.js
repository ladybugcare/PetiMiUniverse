...
exports.streamPaymentReceiptPdf = streamPaymentReceiptPdf;
...
function valueRow(doc, label, value, x, y, w) {
...
function streamPaymentReceiptPdf(res, receipt) {
    ...
    doc.font('Helvetica').fontSize(9).fillColor(TEXT_MUTED).text('Comprovante gerado pelo PetMi Hub.', margin, doc.page.height - 64, { align: 'center', width: contentW });
    doc.end();
}
