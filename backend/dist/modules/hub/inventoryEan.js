...
exports.normalizeEanDigits = normalizeEanDigits;
exports.isValidEanChecksum = isValidEanChecksum;
exports.parseOptionalEan = parseOptionalEan;
/** Normaliza EAN para só dígitos. */
function normalizeEanDigits(raw) {
    return raw.replace(/\D/g, '');
}
function checksumEan13Body(body12) {
    let sum = 0;
    for (let i = 0; i < 12; i++) {
...
function checksumEan8Body(body7) {
    let sum = 0;
    for (let i = 0; i < 7; i++) {
