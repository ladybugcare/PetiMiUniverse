...
-- Pré-requisitos: 024a_create_hub_clinical_cases.sql já aplicado.
-- hub_case_id começa NULLABLE para permitir backfill sem downtime.
-- Após backfill (025n_backfill_hub_clinical_cases.sql), aplicar 025d_alter_hub_encounters_case_not_null.sql.
