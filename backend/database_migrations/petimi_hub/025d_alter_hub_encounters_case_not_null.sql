...
BEGIN
  ...
  IF orphan_count > 0 THEN
    RAISE EXCEPTION 'Backfill incompleto: % atendimentos ativos ainda sem hub_case_id. Execute 025n_backfill_hub_clinical_cases.sql antes de continuar.', orphan_count;
  END IF;
END $$;
