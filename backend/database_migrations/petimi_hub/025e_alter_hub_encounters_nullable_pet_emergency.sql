...
-- Pré-requisitos: 025b_create_hub_encounters.sql, 025c_alter_hub_encounters_add_case.sql.
--
...
-- Remove NOT NULL de hub_case_id caso tenha sido aplicado por 025d_alter_hub_encounters_case_not_null.sql.
