...
-- quando só correu `012_create_hub_appointments.sql` e ainda não `013_alter_hub_appointments_multi_service_and_recurrence.sql`.
--
-- Idempotente (IF NOT EXISTS / ADD COLUMN IF NOT EXISTS).
-- Pré-requisitos: `012_create_hub_appointments.sql`, função `moddatetime`, tabela `clinics`.
--
