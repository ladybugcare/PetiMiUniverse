...
-- Pré-requisitos: 025i_create_hub_prescriptions_vaccinations.sql, 024a_create_hub_clinical_cases.sql,
--                008_create_hub_inventory.sql, 025q_alter_hub_clinical_attachments_add_exam.sql.
