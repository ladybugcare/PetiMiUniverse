...
-- Executar UMA vez após 024a_create_hub_clinical_cases.sql e 025c_alter_hub_encounters_add_case.sql.
-- Idempotente: só processa encounters com hub_case_id IS NULL.
-- Regra: 1 caso por encounter (sem agrupamento por janela temporal).
-- Após este script, executar 025d_alter_hub_encounters_case_not_null.sql somente se:
