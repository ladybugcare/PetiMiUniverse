...
import { hubWebPath } from '../utils/hubWebUrl';
  ...
  private static getClinicAdminMenuItems(): MenuItem[] {
    return [
      ...
      },
      {
        id: 'hub-guardians',
        label: 'Clientes (Hub)',
        icon: <UserCircle size={20} color="#c86a4d" />,
        action: 'navigate',
        path: hubWebPath('/hub/clientes'),
        group: 'PetMi Hub',
        order: 1,
      },
      {
        id: 'hub-pets',
        label: 'Pets (Hub)',
        icon: <Heart size={20} color="#c86a4d" />,
        action: 'navigate',
        path: hubWebPath('/hub/pets'),
        group: 'PetMi Hub',
        order: 2,
      },
      {
        id: 'hub-orcamentos',
        label: 'Orçamentos (Hub)',
        icon: <FileText size={20} color="#c86a4d" />,
        action: 'navigate',
        path: hubWebPath('/hub/orcamentos'),
        group: 'PetMi Hub',
        order: 3,
      },
      {
        id: 'hub-service-types',
        label: 'Serviços (Hub)',
        icon: <Tags size={20} color="#c86a4d" />,
        action: 'navigate',
        path: hubWebPath('/hub/servicos'),
        group: 'PetMi Hub',
        order: 4,
      },
      {
