...
export const ClientesPagination: React.FC<ClientesPaginationProps> = ({
  ...
  return (
    <div className="hub-clientes-pagination">
      <span>
        Mostrando {from} a {to} de {total.toLocaleString('pt-BR')} {entityLabel}
      </span>
      <div className="hub-clientes-pagination__pages">
        <button
          type="button"
          className="hub-clientes-pagination__page"
          disabled={safePage <= 1}
        ...
        {visible.map((p, idx) => {
          ...
          return (
            <React.Fragment key={p}>
              ...
              <button
                type="button"
                className={`hub-clientes-pagination__page ${p === safePage ? 'hub-clientes-pagination__page--active' : ''}`}
      ...
      <div className="hub-clientes-pagination__per-page">
        <label htmlFor="hub-clientes-per-page" className="hub-clientes__muted" style={{ fontSize: 13 }}>
          Por página
        </label>
        <HubSearchableCombobox
          id="hub-clientes-per-page"
